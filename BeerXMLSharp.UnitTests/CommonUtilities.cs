...
namespace BeerXMLSharp.UnitTests
{
    internal static class CommonUtilities
    {
        #region TestXML

        public static readonly string TEST_XML_DRY_STOUT = @"<?xml version=""1.0"" encoding=""iso-8859-1""?>
  ...
  <RECIPE>
    ...
    <MASH>
      ...
      <MASH_STEPS>
        ...
        /// </summary>
        /// <returns></returns>
        public static MemoryStream GetTestXmlStream(string xml)
        {
